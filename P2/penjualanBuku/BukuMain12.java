...
public class BukuMain12 {
    public static void main(String[] args) {
        ...
        Buku12 bk2 = new Buku12("How to Train Your Dragon", "Cressida Cowell", 432, 5, 275000);
        bk2.terjual(4);
        bk2.tampilInformasi();
        ...
        bukuFatikah.hitungHargaTotal(2);
        bukuFatikah.hitungDiskon(2);
        bukuFatikah.hitungHargaBayar(2);
    }
}
